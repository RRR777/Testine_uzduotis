        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <span class="h2">Įveskite Naują transporto priemonę</span>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-9 mb-9">
                                    <input type="text"
                                           ...
                                           placeholder="Įveskite transporto priemonę"
                                           required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                      ...
                                      <input type="number"
                                             ...
                                             placeholder="Stovėjimo kuro norma"
                                             required>
                                      <small id="helpId"
                                             class="form-text text-muted">
                                             * Stovėjimo Kuro norma l/h
                                      </small>
                                      <div class="invalid-feedback">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                      ...
                                      <input type="number"
                                             ...
                                             aria-describedby="helpId"
                                             placeholder="Važiavimo kuro norma"
                                             required>
                                      <small id="helpId" 
                                             class="form-text text-muted">
                                                * Važiavimo Kuro norma l/h
                                      </small>
                                      <div class="invalid-feedback">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                      ...
                                      <input type="number"
                                             ...
                                             aria-describedby="helpId"
                                             placeholder="Iškrovimo kuro norma"
                                             required>
                                      <small id="helpId"
                                             class="form-text text-muted">
                                                * Iškrovimo Kuro norma l/h
                                      </small>
                                      <div class="invalid-feedback">
